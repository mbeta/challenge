...
public class ExcepcionPrecios extends Exception implements ExcepcionGenerica {
    ...
    public ExcepcionPrecios(final String mensaje, final DetalleErrorPrecios detalle) {
        super(mensaje);
        this.detalles = Collections.singletonList(detalle);
    }

    public ExcepcionPrecios(final String mensaje, final List<DetalleErrorPrecios> detalles) {
        super(mensaje);
